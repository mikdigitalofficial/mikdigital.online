  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-24">
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(91,33,255,0.06) 0%, rgba(255,255,255,1) 50%, rgba(255,213,79,0.08) 100%)',
      ...
      >
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="rounded-[32px] border border-zinc-200 bg-white p-8 shadow-xl">
            ...
            {success && (
              <div className="mt-5 rounded-2xl border border-green-200 bg-green-50 px-5 py-4 text-green-700">
