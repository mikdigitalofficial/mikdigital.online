...
const caseStudies = [
  {
    ...
    description: "Meta Ads and WhatsApp funnel systems focused on increasing preschool admissions and improving parent inquiry conversion across UAE. Built and operated in-house — every campaign, every lead, every result owned directly.",
  ...
  },
  {
    ...
    description: "Community-focused acquisition campaigns targeting Indian audiences in Adelaide using Meta Ads, Google Ads, and WhatsApp funnels — delivering 2X+ ROAS consistently through in-house owned tracking and CRM infrastructure.",
...
export default function CaseStudiesPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/[0.06]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-20 md:pb-32 md:pt-28">
          ...
          <p className="mt-8 max-w-2xl text-xl leading-9 text-zinc-400">
            Results from years of in-house performance marketing work — every number owned directly, no agency middlemen. Education and entertainment brands across UAE and Australia, consistently delivering 2X ROAS and above.
          </p>
              ...
              >
                <div className="overflow-hidden border-b border-white/[0.06] relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="rounded-full border border-violet-500/30 bg-violet-500/20 px-3 py-1 text-xs font-bold text-violet-300 backdrop-blur-sm">
                      {study.market}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-8 md:p-10">
                  ...
                  <p className="mt-4 text-base leading-8 text-zinc-400">{study.description}</p>

                  <div className="mt-8 rounded-xl border border-violet-500/20 bg-violet-500/[0.08] p-6">
                    <p className="text-xs font-bold uppercase tracking-widest text-violet-400">Key Result</p>
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {study.tags.map((t) => (
                      <span key={t} className="rounded-full border border-white/[0.08] px-3 py-1 text-sm font-medium text-zinc-400">
                        {t}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="mt-8">
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-base font-bold text-white transition hover:opacity-90"
      ...
      <section className="border-b border-white/[0.06] py-24">
        <div className="mx-auto max-w-7xl px-6">
          <p className="text-sm font-bold uppercase tracking-widest text-violet-400">Campaign performance</p>
          <h2 className="mt-6 text-4xl font-black text-white md:text-5xl">Numbers from the dashboards.</h2>
          <p className="mt-5 text-xl text-zinc-400">Unedited screenshots from real campaigns — 2X ROAS minimum, up to 20X at peak.</p>
          ...
          <div className="mt-16 rounded-2xl border border-white/[0.08] bg-white/[0.02] p-8 md:p-12">
            <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-sm font-bold uppercase tracking-widest text-violet-400">Get similar results</p>
                <h3 className="mt-4 text-3xl font-black text-white md:text-4xl">Ready to build your system?</h3>
                <p className="mt-4 max-w-lg text-xl text-zinc-400">
                  These results came from in-house ownership — not remote account management. Talk directly with Mohamed to see what 2X+ ROAS looks like for your business.
                </p>
              </div>
              <div className="flex flex-col gap-3 flex-shrink-0">
                <a
                  ...
                  className="inline-flex items-center gap-2 whitespace-nowrap rounded-xl px-7 py-4 text-base font-bold text-white transition hover:opacity-90"
                  style={{ background: 'linear-gradient(135deg, #7c3aed, #a855f7)' }}
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl border border-white/10 bg-white/[0.04] px-7 py-4 text-base font-bold text-white transition hover:bg-white/[0.08]"
                >
                  Message on WhatsApp
                </a>
              </div>
